...
function NavBar(){
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold curser-pointer">BOOK STORE</a>
  </div>
...
<label className="swap swap-rotate">
  ...
  <div className=''>
    <a className="bg-green-500 px-2 py-2 text-white p-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
